...
AD %>% mutate_if(is.character, str_to_upper) -> AD

AD <- mutate(AD,
             `NSAID` = str_detect(drug_1, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)") |
               str_detect(drug_2, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)") |
               str_detect(drug_3, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)") |
               str_detect(drug_4, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)") |
               str_detect(drug_5, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)") |
               str_detect(drug_6, "(ASPIRIN)|(DICLOFENAC)|(PIROXICAM)|(ACECLOFENAC)|(TENOXICAM)|(INDOMETHACIN)|(NAPROXEN)|(NABUMETONE)|(FLURBIPOFEN)|(IBUPROFEN)|(KETOPROFEN)|(KETOROLAC)|(DROXICAM)|(NEKIXICAM)|(SULINDAC)|(NIFLUMIC ACID)|(ACEMETACIN)|(ISONIXIN)"))
```
